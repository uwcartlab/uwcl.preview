...
def main():
    def removeYear(): 
        for filename in os.listdir("C:/Users/Tim/Desktop/Workspace/uwcl.preview/education/G370/2018FA/PDF"):
            print(filename)
    def organizeLetters():
        for filename in os.listdir("C:/Users/Tim/Desktop/Workspace/uwcl.preview/education/G370/2018FA/PDF"):
            i=1
            ...
            print("<img src='2018FA/ImgSq/" + filename.strip('.pdf') + ".png' " + "alt='...' class='final'>")
