...
class WPEX_Welcome {
	...
	public function about_screen() { ?>
		<div class="wrap about-wrap">
			...
			$stripped_theme_name = strtolower ( $theme_name );
			$stripped_theme_name = str_replace( 'wpex', '', $stripped_theme_name );
			$stripped_theme_name = trim( $stripped_theme_name ); ?>
			...
			<div>
				<div class="feature-section">
					...
					<div>
						...
						<a href="http://www.wpexplorer.com/<?php echo $stripped_theme_name; ?>-wordpress-theme/" target="_blank" class="button button-primary"><?php _e('Theme Page','wpex'); ?></a>
						<a href="http://www.wpexplorer.com/documentation/<?php echo $stripped_theme_name; ?>/" target="_blank" class="button button-primary"><?php _e('Documentation','wpex'); ?></a>
						<a href="http://www.wpexplorer.com/changelogs/<?php echo $stripped_theme_name; ?>/" target="_blank" class="button button-primary"><?php _e('Changelog','wpex'); ?></a>
					</div>
