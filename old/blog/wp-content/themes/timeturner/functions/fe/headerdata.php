...
function timeturner_display_footer_widgets() { 
    $theme_folder = get_template_directory_uri();
		...
		<?php echo '#wrapper #footer { padding: 35px 0 25px; } #wrapper .footer-signature { background: left top repeat-x url('; ?><?php echo $theme_folder ?><?php echo '/images/line-footer.png); }'; ?>
<?php } 
}

// Background color and image
function timeturner_background_color_and_image() {
    $background_color = get_background_color();
    $background_image = get_background_image(); 
    $background_repeat = get_theme_mod( 'background_repeat', get_theme_support( 'custom-background', 'background-repeat' ) );
    $background_position = get_theme_mod( 'background_position_x', get_theme_support( 'custom-background', 'background-position' ) );
    $background_attachment = get_theme_mod( 'background_attachment', get_theme_support( 'custom-background', 'background-attachment' ) );
		if ($background_color != '') { ?>
		<?php echo '#wrapper #wrapper-about, #wrapper #wrapper-blog, #wrapper #wrapper-content, #wrapper .about-box, #wrapper .about-box .about-radius { background-color: #'; ?><?php echo $background_color ?><?php echo ';}'; ?>
<?php } if ($background_image != '') { ?>
		<?php echo '#wrapper #wrapper-about, #wrapper #wrapper-blog, #wrapper #wrapper-content { background-image: url('; ?><?php echo $background_image ?><?php echo '); background-position: '; ?><?php echo $background_position ?><?php echo ' top; background-repeat: '; ?><?php echo $background_repeat ?><?php echo '; background-attachment: '; ?><?php echo $background_attachment ?><?php echo ';}'; ?>
<?php } 
}
...
<?php timeturner_display_footer_widgets(); ?>
<?php timeturner_background_color_and_image(); ?>
