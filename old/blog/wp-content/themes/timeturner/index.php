...
if (have_posts()) : while (have_posts()) : the_post(); ?>
      <div <?php post_class('post-entry'); ?>>
        ...
        <div class="post-entry-content">
          ...
          <p class="post-data"><?php _e( 'Published: ', 'timeturner' ); ?><a href="<?php echo get_permalink(); ?>"><?php echo get_the_date(); ?></a><?php if ( comments_open() ) : ?><?php _e( ' | Comments: ', 'timeturner' ); ?><a class="article-comments" href="<?php comments_link(); ?>"><?php comments_number( '0', '1', '%' ); ?></a><?php endif; ?></p>
        </div>
      </div>
<?php endwhile; endif; ?>
