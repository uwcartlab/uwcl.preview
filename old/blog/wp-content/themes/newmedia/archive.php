...
<?php }; ?>
					...
					<div class="archivetek"><?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'newmedia' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'newmedia' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'newmedia' ) ) );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'newmedia' ), get_the_date( _x( 'Y', 'yearly archives date format', 'newmedia' ) ) );

						else :
							_e( 'Archives', 'newmedia' );
