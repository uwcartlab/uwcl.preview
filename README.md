 ...
 * ```fileType``` The [mime type](https://en.wikipedia.org/wiki/Media_type) of the file.  A list of supported file types and their interpretations is [here](http://cartlabserver.shc.wisc.edu:8080/mediaTypes) (must be on an SHC computer to view).
